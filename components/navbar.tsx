        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-1.5 text-muted-foreground hover:text-gold transition-colors text-sm font-medium px-2 py-2"
              aria-label="Follow on Instagram"
            >
              <InstagramIcon size={18} />
              <span>@tradeverse_city</span>
            </a>
            <a
          ...
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-3 flex flex-col gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-secondary border border-border text-foreground font-semibold text-sm px-4 py-2.5 rounded-md hover:text-gold hover:border-gold transition-colors"
              >
